...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            driver.find_element_by_xpath("//button[@class='e1jbctw80 ei0fd8p1 css-1n14mz9 e1q8sty40']").click()  #clicking to the X.
        except NoSuchElementException:
            pass


        #Going through each job in this page
        job_buttons = driver.find_elements_by_xpath('.//li[@class="react-job-listing css-108gl9c eigr9kq3"]//a')  #jl for Job Listing. These are the buttons we're going to click.
        for job_button in job_buttons:
            ...
            while not collected_successfully:
                try:
                    ...
                    job_description = driver.find_element_by_xpath('.//div[@class="p-std css-1k5huso e856ufb0"]').text
            ...
            try:
                rating = driver.find_element_by_xpath('.//div[@class="css-87uc0g e1tk4kwz1"]').text
...
'''
            ...
            '''try:
                competitors = driver.find_element_by_xpath('//span[text()="Type"]/following-sibling::*').text
            except NoSuchElementException:
                competitors = -1'''
